...
export default function DynamicInfoCard() {
  ...
  const statusLabel = useMemo(() => {
    ...
    if (wallet.createdAddress) return 'Vault ready'
    return 'Idle'
  ...
  return (
    <motion.aside
      ...
      className="fixed right-6 top-24 z-50 w-[320px] select-none sm:right-10 sm:top-28"
    >
      <div className="rounded-[20px] border border-white/10 bg-black/70 shadow-2xl shadow-black/50 backdrop-blur-xl">
        <div className="rounded-t-[20px] border-b border-white/10 bg-gradient-to-b from-white/10 to-transparent p-4">
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 rounded-full bg-gradient-to-br from-[#d96f42] via-[#c9a24d] to-emerald-400 p-[1px]">
              ...
              <div className="min-w-0">
                ...
                <div className="truncate text-xs tracking-wide text-white/60">{secondaryLine}</div>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <div className="text-xs font-semibold tabular-nums tracking-tight text-white">{timeLabel}</div>
              <div className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2.5 py-1 text-xs font-semibold tracking-wide text-white/80">
            ...
            {hovered ? (
              ...
              >
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="text-[11px] uppercase tracking-[0.2em] text-white/40">Hover view</div>
                </div>
              </motion.div>
            ) : (
              <motion.div
              ...
              >
                ...
                <div className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs font-semibold tracking-wide text-white/70">
                  Expand on hover
                </div>
              </motion.div>
            )}

...
const statBlocks = [
  { label: 'Ready for mainnet', value: 'EVM-first', detail: 'Wagmi + Ethers wired for production flows' },
  { label: 'Security posture', value: 'Toy-safe', detail: 'Encrypted locally with session handoff for demos' },
  { label: 'UX philosophy', value: 'Frictionless', detail: 'Guided unlocks, optimistic updates, low-latency UI' },
]
...
export default function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-b from-[#0c0a08] via-[#130f0d] to-[#0a0b0f] text-white shadow-[0_30px_120px_rgba(0,0,0,0.8)]">
      {/* hero layers */}
      <FogParticleOverlay />
      <FloatingSigils />
      <TitleCalligraphy />

      <div className="relative z-10 flex flex-col gap-14 px-6 pb-24 pt-16 lg:px-10 lg:pt-24">
          ...
          <div className="space-y-8">
            ...
            <header className="space-y-4">
              ...
              <p className="max-w-2xl text-lg text-white/80">
                ...
                Generate wallets, track connections, and surface security posture without leaving the landing surface.
              </p>
            </header>
